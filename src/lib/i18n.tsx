...
export const t: Dict = {
  ...
  "about.team.eyebrow": { en: "Founding Team", zh: "创始团队" },
  "about.team.title": {
    en: "Built by engineers\nwho shipped NFC at scale.",
    zh: "由真正交付过 NFC 的\n工程师团队打造。",
  },
  "about.team.sub": {
    en: "Two decades of hands-on experience in payments, transit, secure elements and contactless hardware — all under one roof.",
    zh: "在支付、交通、安全芯片与 contactless 硬件领域拥有 20 年实战经验，全部凝聚在同一支团队。",
  },
  "about.team1.role": { en: "CTO & Co-founder", zh: "CTO · 联合创始人" },
  "about.team1.exp": { en: "20 years in NFC", zh: "20 年 NFC 行业经验" },
  "about.team1.bio": {
    en: "Spent two decades shipping secure-element and contactless products — led the firmware behind 200+ EMV, transit and access deployments across Asia, Europe and the Americas. Holds patents on low-power NFC protocol stacks and tap-to-cloud provisioning.",
    zh: "20 年深耕安全芯片与 contactless 产品，主导过 200+ 个 EMV、交通与门禁项目的固件交付，覆盖亚、欧、美三大区域。在低功耗 NFC 协议栈与「碰一碰上云」领域持有多项专利。",
  },
  "about.team2.role": { en: "CEO & Co-founder", zh: "CEO · 联合创始人" },
  "about.team2.exp": { en: "15 years in payments", zh: "15 年支付行业经验" },
  "about.team2.bio": {
    en: "Founded NFCTEC in 2010 in Shenzhen after running EMV consulting at a top-five issuer. Built the company from a four-person SDK team into a 500-project, 60-country operation — without ever losing the engineering-first culture.",
    zh: "2010 年于深圳创办 NFCTEC，此前曾在全球前五的卡组织主导 EMV 咨询项目。将公司从 4 人 SDK 团队发展为覆盖 60 国、交付 500+ 项目的国际化团队，始终坚持工程师文化。",
  },
  "about.team3.role": { en: "VP Hardware", zh: "硬件副总裁" },
  "about.team3.exp": { en: "18 years in RFID hardware", zh: "18 年 RFID 硬件经验" },
  "about.team3.bio": {
    en: "Designed the company's reader and module line — from low-cost OEM boards to PCI-compliant payment terminals. Previously shipped 30M+ contactless readers at a tier-one reader manufacturer.",
    zh: "主导公司读卡器与模组产品线 — 从低成本 OEM 板卡到 PCI 认证支付终端。曾任职全球头部读卡器厂商，累计出货 3000 万+ contactless 读卡器。",
  },
  "about.team4.role": { en: "VP Solutions", zh: "方案副总裁" },
  "about.team4.exp": { en: "12 years in transit & access", zh: "12 年交通与门禁经验" },
  "about.team4.bio": {
    en: "Runs the delivery organization. Implemented Calypso, OSPT CIPURSE and open-loop transit systems in 30+ cities, and led the JavaCard applet team that certifies with Visa, Mastercard and UnionPay.",
    zh: "负责项目交付体系。已在全球 30+ 个城市落地 Calypso、OSPT CIPURSE 及开放式 transit 系统，并带领 JavaCard Applet 团队通过 Visa、Mastercard、银联认证。",
  },
  ...
  "about.stats.team": { en: "120+ engineers", zh: "120+ 工程师" },
