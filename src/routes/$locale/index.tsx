...
function Home() {
  ...
  const pillars = [
    { icon: Code2, t: tr("pillar.sw.title"), d: tr("pillar.sw.desc"), to: "/$locale/products" as const },
    { icon: Cpu, t: tr("pillar.hw.title"), d: tr("pillar.hw.desc"), to: "/$locale/products" as const },
    { icon: Layers, t: tr("pillar.sol.title"), d: tr("pillar.sol.desc"), to: "/$locale/solutions" as const },
    { icon: Wrench, t: tr("pillar.dev.title"), d: tr("pillar.dev.desc"), to: "/$locale/platform" as const },
  ];
