    ...
    <>
      ...
      <section className="pt-24 lg:pt-28 pb-4">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <Link to="/$locale/products" params={{ locale }} className="inline-flex items-center gap-2 text-xs font-mono text-muted-foreground hover:text-primary transition-colors">
