      ...
      <section className="relative pt-24 lg:pt-32 pb-16 lg:pb-20">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/$locale/auth" params={{ locale }} className="inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground px-6 py-3 text-sm font-semibold hover:shadow-glow-strong transition-all">
              {lang === "zh" ? "免费开始" : "Get Started Free"} <ArrowRight size={16} />
            </Link>
            <Link to="/$locale/contact" params={{ locale }} className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/50 px-6 py-3 text-sm font-semibold hover:border-primary/50 transition-colors">
